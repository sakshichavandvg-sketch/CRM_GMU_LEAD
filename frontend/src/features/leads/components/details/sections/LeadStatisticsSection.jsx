  ...
  return (
    <section className="grid grid-cols-12 gap-lg">
      ...
      <div className="col-span-3 flex flex-col gap-lg">
        <div className="premium-card p-lg rounded-lg flex items-center gap-lg">
      ...
      {/* Admission Progress */}
      <div className="col-span-3 premium-card p-lg rounded-lg bg-[#FFF9E6] border-[#F59E0B]/20 flex flex-col items-center justify-center text-center">
        <div className="w-16 h-16 rounded-full bg-[#F59E0B]/10 flex items-center justify-center text-[#F59E0B] mb-md">
          <span className="material-symbols-outlined text-headline-lg" style={{ fontVariationSettings: "'FILL' 1" }}>school</span>
        </div>
        <p className="text-label-md text-[#B45309] font-bold uppercase tracking-widest mb-xs">Admission Progress</p>
        <h3 className="font-display-lg text-display-lg text-[#F59E0B]">{progressPercentage}%</h3>
        <p className="text-body-sm text-[#B45309] mb-lg">{progressLabel}</p>
      ...
      {/* Lead Pipeline */}
      <div className="col-span-6 premium-card p-lg rounded-lg flex flex-col justify-between">
        <h3 className="font-label-md text-on-surface mb-lg">Lead Pipeline</h3>
        <div className="relative h-24 flex items-center">
          <div className="pipeline-line"></div>
          <div className="relative z-10 w-full flex justify-between px-sm">
            {stages.map((s, index) => {
              ...
              if (isCompleted) {
                return (
                  <div key={s.key} className="flex flex-col items-center gap-sm">
